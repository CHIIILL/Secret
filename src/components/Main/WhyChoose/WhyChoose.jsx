      ...
      <div className={s.cardsBox}>
        <div className={s.card}>
          ...
          <p className={s.description}>
            Intellectero is a full-strack development company that operates in
            FinTech, Defi, NTF and Blockchain industries.
          </p>
        </div>
        <div className={s.card}>
          ...
          <p className={s.description}>
            ...
            products and help them to enter the web.
          </p>
        </div>
        <div className={s.card}>
          ...
          <p className={s.description}>
            We gathered the best specialists and now our team consists of more
            than 20 members.
          </p>
        </div>
      </div>
