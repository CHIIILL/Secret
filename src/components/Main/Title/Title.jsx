...
import TitlePhoneImg from './../../../assets/img/TitlePhoneImg.svg';
    ...
    <section className={s.section} id="Home">
      <div className={s.box}>
        ...
        <h2 className={s.subtitle}>
          Developing FinTech,Blockchain,
          <br />
          DeFi and NFT Projects
        </h2>
        <p className={s.text}>
          Get the ready made projects on a turnkay basis.Develop your idea with
          Intellectero from scratch. Enjoy quality and unique products.
        </p>
        <div className={s.titlePhoneImg}>
          <img src={TitlePhoneImg} alt="titleImg" />
        </div>
